"""Regression checks for the cobalt-rel-restore-grid casebook."""
...
from casebook.harness import assert_expected, cobalt_rel_restore_grid_summary
...
class CasebookTests(unittest.TestCase):
    ...
    def test_named_summary_alias(self) -> None:
        self.assertEqual(cobalt_rel_restore_grid_summary(), assert_expected())
