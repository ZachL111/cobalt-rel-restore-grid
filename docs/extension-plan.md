...
`cobalt-rel-restore-grid` has a compact core implementation, golden fixtures, extended examples, and a repository audit script. The model is intentionally small enough to inspect by hand while still exercising real control flow and validation.
