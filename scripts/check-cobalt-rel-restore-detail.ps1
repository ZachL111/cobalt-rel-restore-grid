...
$repo = "cobalt-rel-restore-grid"
$language = "Solidity"
$category = "Reliability"

foreach ($path in @("metadata/domain-review.json", "config/review-profile.json", "fixtures/domain_review.csv", "docs/field-notes.md", "docs/review-journal.md", "examples/cobalt-rel-restore-walkthrough.md")) {
